...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(472, 508);
        MainWindow->setMinimumSize(QSize(472, 508));
        MainWindow->setMaximumSize(QSize(472, 508));
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/timetask-ico.ico"), QSize(), QIcon::Normal, QIcon::Off);
        MainWindow->setWindowIcon(icon);
        MainWindow->setStyleSheet(QLatin1String("selection-background-color: rgb(0, 0, 0);\n"
"background-color: rgb(250, 255, 188);\n"
"selection-color: rgb(215, 132, 0);"));
...
""));
        ...
        label_2->setGeometry(QRect(350, 430, 81, 41));
        ...
        line->setGeometry(QRect(330, 430, 20, 41));
