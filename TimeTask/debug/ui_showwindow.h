...
public:
    ...
    void setupUi(QDialog *ShowWindow)
    {
        ...
        tableView->setGeometry(QRect(320, 20, 331, 71));
        ...
        tableView_2->setGeometry(QRect(330, 130, 361, 111));
